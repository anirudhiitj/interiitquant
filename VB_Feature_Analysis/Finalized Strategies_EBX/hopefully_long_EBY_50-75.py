...
PRE_DROP_SL = 0.4  # <--- NEW PARAMETER: Static SL for the first 30min short
...
# Exit (Short)
SHORT_STATIC_SL = 0.1        # Static Stop Loss
SHORT_TP_ACTIVATION = 999.0     # Profit required to activate trailing
...
# Final Capital                 : 104.30
# Total PnL                     : 4.30
# Total Transaction Cost         : 3.35
# Penalty Counts                : 0
# Final Returns                 : 4.30%
# CAGR                          : 2.1020%
# Annualized Returns            : 2.1246%
# Sharpe Ratio                  : 0.8727
# Calmar Ratio                  : 2.2745
# Maximum Drawdown              : -0.9341%
# No. of Days                   : 510
# Winning Days                  : 21
# Losing Days                   : 30
# Best Day                      : 306
...
# Losing Trades                 : 95
# Win Rate (%)                  : 43.45%
# Average Winning Trade         : 0.4673
# Average Losing Trade          : -0.2253
# Average Hold Period (seconds) : 9,148.34
# Average Hold Period (minutes) : 152.47
# ========================