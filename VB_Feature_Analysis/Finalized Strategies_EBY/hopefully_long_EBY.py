...
def process_day(file_path: str, day_num: int, temp_dir: pathlib.Path, strategy_params) -> str:
    try:
        ...
        if not np.any(mask_30min):
            ...
            # Gating Condition: Sigma > Threshold AND Mu < Threshold
...
# Final Capital                 : 105.28
# Total PnL                     : 5.28
# Total Transaction Cost         : 2.35
# Penalty Counts                : 0
# Final Returns                 : 5.28%
# CAGR                          : 4.7539%
# Annualized Returns            : 4.7658%
# Sharpe Ratio                  : 1.4850
# Calmar Ratio                  : 3.3218
...
# Losing Trades                 : 68
# Win Rate (%)                  : 42.37%
# Average Winning Trade         : 0.4559
# Average Losing Trade          : -0.2005
# Average Hold Period (seconds) : 7,826.12
# Average Hold Period (minutes) : 130.44
# ========================