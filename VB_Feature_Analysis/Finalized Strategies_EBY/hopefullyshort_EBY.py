...
MU_THRESHOLD = 100.0    # Logic looks for Mu > 100

# 1. Primary Entry (Short)
ENTRY_RISE_THRESHOLD = 0.8  # Price must RISE 0.8 above Open

# 2. Primary Exit (Short)
PRIMARY_STATIC_SL = 0.7
PRIMARY_TP_ACTIVATION = 0.65
PRIMARY_TRAIL_CALLBACK = 0.15
...
def process_day(file_path: str, day_num: int, temp_dir: pathlib.Path, strategy_params) -> str:
    try:
        ...
        if not np.any(mask_30min):
            ...
            # Gating Condition: Sigma > Threshold AND Mu > 100
...
# Final Capital                 : 106.97
# Total PnL                     : 6.97
# Total Transaction Cost         : 2.01
# Penalty Counts                : 0
# Final Returns                 : 6.97%
# CAGR                          : 6.2749%
# Annualized Returns            : 6.2956%
# Sharpe Ratio                  : 2.0610
# Calmar Ratio                  : 7.1412
# Maximum Drawdown              : -0.8816%
# No. of Days                   : 279
# Winning Days                  : 18
# Losing Days                   : 10
# Best Day                      : 69
...
# Losing Trades                 : 49
# Win Rate (%)                  : 51.00%
# Average Winning Trade         : 0.4861
# Average Losing Trade          : -0.1774
# Average Hold Period (seconds) : 7,641.02
# Average Hold Period (minutes) : 127.35
# ========================