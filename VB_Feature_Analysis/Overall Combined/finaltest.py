...
CONFIG = {
    ...
    'OUTPUT_FILE': 'combined_signals_EBY_copy.csv',
...
def generate_p1_signals(df: pd.DataFrame, config: dict) -> np.ndarray:
    """Generate Priority 1 signals with Strict EOD"""
...
def apply_manager_logic(df_time_sec, p1_signals, p2_signals, p3_signals, p4_signals, p5_signals, config_cooldown):
    """Manager Logic updated for 5 Priorities."""
    n = len(df_time_sec)
...
def main(config):
    ...
    print("="*80)
    print("STRATEGY MANAGER - 5-PRIORITY SIGNAL ROUTING")
    print("="*80)
